...
// function to create empty table on the basis of the given number of inout
...
// function to fill the random input by the random input valur for the processes
function fillRandom(){
  no_of_process = Number(document.getElementById('noOfProcess').value)
...
// read table to create the process list
function readTable() {
  AllProcess = [];
...
// function to create the random process for the testing phase
...
// function to create the static process for the testing phase
...
// function to validate the given process table input
...
// function to run the roundrobin algorithm
