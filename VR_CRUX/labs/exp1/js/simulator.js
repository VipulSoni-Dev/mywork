...
function startSimulator(canv){
  ...
  if (AnimProcessChart == null) {
      AnimProcessChart = new Animation(canv);
  ...
  function createLabel(){
    ...
    var yOriginForReadyQueue = yorigin + (no_of_process + labelGap) * height
    createRectangle(
    ...
    xOriginForReadyQueue = xOriginForReadyQueue + 50
    ...
    xOriginForReadyQueue = xOriginForReadyQueue + 100
