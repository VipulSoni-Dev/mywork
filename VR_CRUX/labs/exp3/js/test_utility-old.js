...
{
    console.log(printProcess(process))
    
   // TestCompleteQueue.enqueue(process)
    TestCompleteQueue.enqueue(printProcess(process))
}
function printval()
{
...
function totalBt()
{
    ...
    {
        //console.log(TestCompleteQueue.linkedList[i].getProcessBt())
      if(checkCompletedProcess(i))  total+=TestCompleteQueue.linkedList[i].getProcessBt();
      
    }
    
    //console.log((TestCompleteQueue.linkedList[0].getProcessAt()))
